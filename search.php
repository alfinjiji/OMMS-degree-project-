		  ...
		  <div class="modal-body">
			...
			<?php include('adminerrors.php'); ?>
			  <div class="control-group">
				...
				<input type="text" id="inputEmail" name="email" placeholder="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" autofocus required>
			  </div>
			  <div class="control-group">
...
<!-- Sidebar end=============================================== -->
    ...
    <ul class="breadcrumb">
		...
		<li class="active">search_view</li>
    </ul>
          <?php
...
<div class="tab-content">
	...
	<?php
			...
			$sql="SELECT * FROM products WHERE title LIKE '%$search%'  ORDER BY id DESC LIMIT 4";
...
<hr class="soft"/>
 <div class="row">	  
  <div class="span2">
				<a href="product_details.php?id=<?php echo $result['id'];?>"><?php echo "<img src='images/uploads/".$result['image1']."' style='width:160px; height:160px;'>"; ?></a>
			</div>
			<div class="span4">
				<a href="product_details.php?id=<?php echo $result['id'];?>"><?php echo "<h3>".$result['title']."</h3>"; ?></a>			
				<hr class="soft"/>
				<?php echo "<h5>".$result['title']."</h5>"; ?>
				<?php echo "<p>".$result['description']."</p>"; ?>
				<br class="clr"/>
			</div>
			<div class="span3 alignR">
				<form class="form-horizontal qtyFrm">
				<?php echo "<h3>₹ ".$result['price']."</h3>" ; ?>
				<br/>
				
				<a href="cart/cartAction.php?action=addToCart&id=<?php echo $result["id"]; ?>" class="btn btn-large btn-primary"> Add to <i class=" icon-shopping-cart"></i></a>
	...
	<div class="tab-pane  active" id="blockView">
		<ul class="thumbnails">
			...
			$sql="SELECT * FROM products WHERE title LIKE '%$search%'  ORDER BY id DESC LIMIT 9";
			$run=mysqli_query($db,$sql);
			if($run->num_rows > 0){
			while($result=mysqli_fetch_assoc($run))
			{
		  ...
		  <li class="span3">
			  <div class="thumbnail">
			 <a href="product_details.php?id=<?php echo $result['id'];?>"> <?php	echo "<img src='images/uploads/".$result['image1']."' style='width:160px; height:160px;'>"; 
			   echo "<h5>".$result['title']."</h5>"; ?></a>
				<!--<div class="caption">-->
				  <h4 style="text-align:center"> <a class="btn" href="cart/cartAction.php?action=addToCart&id=<?php echo $result["id"]; ?>">Add to <em class="icon-shopping-cart"></em></a>&nbsp;<a class="btn btn-primary" href="#">
				  <?php echo "<h7>₹ ".$result['price']."</h7>" ; ?> </a></h4>
				</div>
			 <!-- </div> -->
			</li>
