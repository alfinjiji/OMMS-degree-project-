...
<!-- Sidebar end=============================================== -->
    ...
    <ul class="breadcrumb">
		...
		<li><a href="../product_summary.php">Shopping Cart</a> <span class="divider">/</span></li>
	...
	<hr class="soft"/>
			<?php
			 if($_SESSION['sessCustomerID'] == 0) { ?>
				<h3><center><b> Login Please...</b></center></h3>
			<?php } else { ?>
	<table class="table table-bordered">
			...
			<tfoot>
	         ...
	         <div class="shipAddr">
        		...
        		<p><?php echo $custRow['fname']; ?></p>
        		<p><?php echo $custRow['address']; ?></p>
        		<p><?php echo $custRow['mobile']; ?></p>
				<p><?php echo $custRow['email']; ?></p>
    		</div>
    		<div class="footBtn">
        		<a href="../products.php?nam=Cameras#menu" class="btn btn-warning"><i class="glyphicon glyphicon-menu-left"></i> Continue Shopping</a>
